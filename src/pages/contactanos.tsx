...
const ContactUs: NextPage = () => {
  ...
  return (
    <Layout title="Contáctanos" description="Contáctanos para más información">
      <div
      ...
      >
        ...
        <div className="flex flex-col bg-white rounded-xl mt-60 z-10 shadow-xl pb-5 w-full md:flex-row md:p-5 md:justify-between md:max-w-screen-lg md:gap-9">
          ...
          <form
            action=""
            className="flex flex-col gap-6 px-4 mt-4 md:w-full md:justify-center"
          >
            <div className="flex flex-col gap-6 md:flex-row">
              <div className="w-full">
                <label
                  className="hidden md:block text-primary font-semibold opacity-50"
                  htmlFor="name"
                >
                  Tu nombre
                </label>
